...
[docs]class MessageBasedResource(Resource):
...
[docs]    def write_raw(self, message: bytes) -> int:
...
[docs]    def read_raw(self, size: Optional[int] = None) -> bytes:
...
[docs]    def query(self, message: str, delay: Optional[float] = None) -> str:
...
[docs]    def assert_trigger(self) -> None:
...
[docs]    def flush(self, mask: constants.BufferOperation) -> None:
